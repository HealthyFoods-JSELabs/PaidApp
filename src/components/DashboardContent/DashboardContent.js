                            ...
                            <Col md="6" xs="12">
                                <Card  className="shadow columncenter" style={{width:"80%",borderRadius:10,border:'none',marginLeft:'8%',marginRight:'5%', marginBottom:"5%",marginTop:"5%"}}>
                                    ...
                                    <Row style={{marginTop:"2%", marginLeft:"-9%"}}>
                                        ...
                                        <Col md="10" xs="8">
                                            <div style={{fontSize: 18, color: "rgb(0,0,0)", marginTop:"0%", marginBottom:"55%"}}>
                                                Total Customers
                                            </div>
                                        </Col>
                        ...
                        <Row style={{}}>
                            <Col md="6" xs="12">
                                <Card className="shadow columncenter" style={{width:"80%",borderRadius:10,border:'none',marginLeft:'8%',marginRight:'5%', marginBottom:"5%",marginTop:"5%"}}>
                                    ...
                                    <Row style={{marginTop:"5%"}}>
                                        ...
                                        <Col md="10" xs="8">
                                            <div style={{fontSize: 18, color: "rgb(0,0,0)", marginTop:"0%", marginBottom:"26%"}}>
                                                Invoice and credits
                                            </div>
                                        </Col>
                            ...
                            <Col md="6" xs="12">
                                <Card className="shadow columncenter" style={{width:"80%",borderRadius:10,border:'none',marginLeft:'8%',marginRight:'5%', marginBottom:"5%",marginTop:"5%"}}>
                                    ...
                                    <Row style={{marginTop:"5%", marginBottom:"23%"}}>
                                        <div style={{fontSize: 24, color: "rgb(20,0,255)", }}>
                                            45 Days
                                        </div>
                                    </Row>
