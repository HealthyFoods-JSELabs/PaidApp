            ...
            <>
                ...
                {/*            <Container style={{width:"100%"}}>*/}
                                <div style={{width:"100%", paddingRight:"1%", paddingLeft:"1%"}}>
                                    <Col  className="shadow" md="12" xs="12" style={{backgroundColor:"#d3d3d3",borderRadius:10, marginBottom:"1%" ,width:"100%"}}>
                                        ...
                                        <Row>
                                            <input placeholder="Phone Number" style={{fontSize: 13, marginTop:"0px", marginBottom:"1px",marginLeft:"10%",marginRight:"10%",border:"none",width:"100%",height:"40px",borderRadius:10, paddingLeft:"2%" }}></input>
                                        </Row>
                                        <Row className="columncenter" style={{marginTop:"3%"}}>
                                            <Button href="/" className="columncenter shadow" style={{borderRadius:20, background: "linear-gradient(to Bottom, #46A26F, #000000)",border:"none",width:"100%", marginLeft:"35%",marginRight:"35%", marginBottom:"10%"}}>
                                                <a className="font-weight-bold" style={{fontSize: 15, color:"rgb(255,255,255)"}}>Register</a>
                                            </Button>
                                        </Row>
                                    </Col>
